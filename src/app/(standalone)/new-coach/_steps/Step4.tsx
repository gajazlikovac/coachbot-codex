...
export default function Step4({ question, category, subquestion, placeholder, value, onChange }: StepProps) {
  return (
...
export function Step4Title() {
  return (
    <h1 className="text-xl font-bold text-dark-aquamarine">ENGAGEMENT STYLE & METHODOLOGY</h1>
  );
}